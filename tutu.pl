...
Como usar: perl tutu.pl (ip) (porta) (pacotes)
Exemplo do uso: perl tutu.pl 127.0.0.1 80 65500

Skype: zambrius.hacking
Pagina: www.facebook.com/cyberteamportugal
...
print "Atacando ip: $ip " . ($port ? $port : "- Created by") . " Zambrius " . 
